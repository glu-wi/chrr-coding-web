...
We can use other software, such as Python and SAS, to extract data via API as well. Here is an example to extract first 20 rows of violation data in CSV format that are health based, from CWS, and on 01-JAN-20 using python:
